...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2021 a las 07:10:00
...
INSERT INTO `inventario` (`id_producto`, `nombre`, `cant_total`, `cant_actual`, `precio`) VALUES
('1', 'Grabadora', 23710, 15, 0),
('2', 'Gansito', 720, 1, 0),
('25', 'Papas', 271, 2, 0),
('5', 'Lechuga', 10333, 9320, 0),
('80', 'gansito', 5033, 2443, 0);
